    ...
    { id: 38, name: "home Ai", price: 99, image: "cool", category: "smarthome-gadgets", description: "Compact smart speaker with Siri and room-filling sound." },
    ...
    { id: 56, name: "OnePlus Nord CE 3", price: 349, image: "images/nord-ce3.jpg", category: "phones", description: "Sleek mid-range phone with strong performance." },
    { id: 57, name: "Corsair Void RGB Elite", price: 99, image: "images/corsair-headset.jpg", category: "gaming", description: "Immersive gaming headset with RGB and clear mic." },
    { id: 58, name: "Nest Cam Indoor", price: 129, image: "images/nest-cam.jpg", category: "smarthome-gadgets", description: "Smart home security cam with real-time alerts." },
    { id: 59, name: "SoundPEATS Mini Pro", price: 49, image: "images/soundpeats.jpg", category: "audio", description: "Budget-friendly ANC earbuds with rich audio." },
    { id: 60, name: "Asus ROG Flow Z13", price: 1699, image: "images/rog-flow.jpg", category: "laptops", description: "Powerful detachable gaming tablet-laptop hybrid." },
      /* ... your product array ... */
    ];
...
function showCartFlash() {
  ...
  setTimeout(() => {
    ...
    function renderProducts(reset = false) {
      ...
      const nextProducts = filteredProducts.slice(visibleCount, visibleCount + step);
    ...
    function filterProducts() {
      ...
      else if (sort === "price-high-low") filteredProducts.sort((a, b) => b.price - a.price);
    ...
    function setupEventListeners() {
      ...
      productList.addEventListener("click", (e) => {
        ...
        else if (e.target.classList.contains("view-details")) handleViewDetails(e);
      });
